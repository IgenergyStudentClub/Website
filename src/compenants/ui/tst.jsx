...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-140 mt-20 flex-col items-center justify-center overflow-hidden  w-full rounded-md z-0",
        className
      )}>
      <div
        ...
        <div
          className="absolute top-1/2 h-5  w-full translate-y-12 scale-x-150  blur-2xl"></div>
        <div
          className="absolute top-1/2 z-50 h-5  w-full  opacity-10 backdrop-blur-md"></div>
        <div
